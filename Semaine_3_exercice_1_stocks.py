...
if m1_stock <= m1_seuil_rupture:
    ...
    m1_couleur = '[ORANGE]'
    m1_action = 'Commande urgent a declencher sous 72h'
    ...
    m1_couleur = '[VERT]'
    m1_action = 'Stituation normale - suivi standard'

# ---CLASSIFICATION MEDICAMENT 2 : Amoxicilline ---
if m2_stock <= m2_seuil_rupture:
    ...
    m2_couleur = '[ORANGE]'
    m2_action = 'Commande urgent a declencher sous 72h'
    ...
    m2_couleur = '[VERT]'
    m2_action = 'Stituation normale - suivi standard'

# --- CLASSIFICATION MEDICAMENT 3 : Paracetamol
if m3_stock <= m3_seuil_rupture:
    ...
    m3_couleur = '[ORANGE]'
    m3_action = 'Commande urgent a declencher sous 72h'
    ...
    m3_couleur = '[VERT]'
    m3_action = 'Stituation normale - suivi standard'

# --- CLASSIFICATION MEDICAMENT 4 : SRO ---
if m4_stock <= m4_seuil_rupture:
    ...
    m4_couleur = '[ORANGE]'
    m4_action = 'Commande urgent a declencher sous 72h'
    ...
    m4_couleur = '[VERT]'
    m4_action = 'Stituation normale - suivi standard'
...
if m5_stock <= m5_seuil_rupture:
    ...
    m5_couleur = '[ORANGE]'
    m5_action = 'Commande urgent a declencher sous 72h'
    ...
    m5_couleur = '[VERT]'
    m5_action = 'Stituation normale - suivi standard'
...
# --- AFFICHAGE RAPPORT ---
print('=' * 60)
print(f' RAPPORT DE STOCK - PHARMACIE NATIONALE D APPROVISIONNEMENT')
print(f' Date : 27 Juin 2026')
print('=' * 60)
...
print(f' Stock limite : {nb_stock_limite}')
print(f' Stocks normaux : {nb_stocks_normaux}')
print('=' * 60)
if nb_ruptures_critiques > 0:
    print(f' !! ALERTE PRIORITAIRE : {nb_ruptures_critiques} medicament en RUPTURE CRITIQUE !! \n Transmettre immediatements au Dr. MOUKALA (PNA)')
print('=' * 60)